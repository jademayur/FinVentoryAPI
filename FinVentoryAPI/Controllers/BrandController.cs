    ...
    public class BrandController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(int id, UpdateBrandDto dto)
        {
            try
            {
                ...
                if (!updated)
                    return NotFound(new { message = "Brand Name not found." });

                return Ok(new { message = "Brand Name updated successfully." });
            }
            catch (Exception ex)
            {
                return BadRequest(new { message = ex.Message });
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            return Ok(new { message = "Brand name deleted successfully." });
        }
